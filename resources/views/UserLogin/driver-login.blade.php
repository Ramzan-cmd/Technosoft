...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/driverlogin.css') }}">
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <div class="login-icon">
                <img src="{{ asset('images/car.png') }}" alt="User Icon">
            </div>

            <h2>Driver Login</h2>
            <p class="subtitle">Start earning with your rides</p>
    ...
    <label>
        ...
        Remember Me
            ...
            <a href="{{ route('driver-register') }}" class="btn-outline">Create Account</a>
        </div>
    </div>
